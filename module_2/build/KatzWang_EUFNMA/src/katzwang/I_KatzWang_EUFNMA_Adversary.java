...
public interface I_KatzWang_EUFNMA_Adversary extends IAdversary<I_KatzWang_EUFNMA_Challenger<IGroupElement, BigInteger>, KatzWangSolution<BigInteger>>{
    /**
     ...
     */
    @Override
    public KatzWangSolution<BigInteger> run(I_KatzWang_EUFNMA_Challenger<IGroupElement, BigInteger> challenger);
    /**
